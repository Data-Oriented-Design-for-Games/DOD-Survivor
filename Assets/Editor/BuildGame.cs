...
namespace Survivor
{
    ...
    public class BuildGame
    {
        ...
        public static void BuildAndroid()
        {
            ...
            Build(BuildTarget.Android, Application.dataPath + "/../../Build/DOD " + dateTime + ".apk", BuildOptions.None);

            AssetDatabase.SaveAssets();
            AssetDatabase.Refresh();
        }

        [MenuItem("DOD/Build/Android Release TEST")]
        ...
        [MenuItem("DOD/Build/Android Release")]
        public static void BuildAndroidRelease()
        {
            setAndroidBuildNumber();

            PlayerSettings.Android.useCustomKeystore = true;
            string path = Application.dataPath + "/../Android/DOD.keystore";
